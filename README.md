...
```json
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "heading": "See also",
      "content": [
        "[Russism](https://en.wikipedia.org/wiki/Rashism), his description of the [state ideology](https://en.wikipedia.org/wiki/State_ideology) of the [Russian Federation](https://en.wikipedia.org/wiki/Russian_Federation)...",
        [
          [
            "Political offices",
            "Political offices",
          ...
          [
            "Preceded by[Declaration of Republic](https://en.wikipedia.org/wiki/Chechen_Republic_of_Ichkeria)",
            "**[President of the Chechen Republic of Ichkeria](https://en.wikipedia.org/wiki/President_of_Ichkeria) [Coat of arms](https://en.wikipedia.org/wiki/File:Coat_of_arms_of_the_Chechen_Republic_of_Ichkeria.svg)** 1991–1996",
            "Succeeded by[Zelimkhan Yandarbiyev](https://en.wikipedia.org/wiki/Zelimkhan_Yandarbiyev)"
          ]
        ]
      ]
    }
